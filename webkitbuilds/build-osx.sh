...
#codesign --sign="Developer ID Application: idanode.org" --verbose=3 --deep "${PATH_NAME}${APP_NAME}.app"
codesign -f -s "idanode.org" --verbose=3 --deep "${PATH_NAME}${APP_NAME}.app"
