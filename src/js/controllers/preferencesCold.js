...
angular.module('copayApp.controllers').controller('preferencesColdController', function ($scope,  profileService, nodeWebkit, isCordova) {
	...
	var self = this;
	self.myDeviceAddress = require('idanode-common/device.js').getMyDeviceAddress();  // 获取我的 设备地址 getMyDeviceAddress
	...
	self.qrcode = "DND:" + JSON.stringify(self.objQr_to_show);
